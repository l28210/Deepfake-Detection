...
##################### 原来使用的代码 ##################
# from visualize.erf.resnet_for_erf import resnet101, resnet152
# from visualize.erf.replknet_for_erf import RepLKNetForERF
...
#     parser.add_argument('--model', default='RepLKNet-31B', type=str, help='model name')
...
def parse_args():
    ...
    parser.add_argument('--model', default='RepLKNet-31B', type=str, help='model name')
    parser.add_argument('--weights', default=None, type=str, help='path to weights file. For resnet101/152, ignore this arg to download from torchvision')
    parser.add_argument('--data_path', default=r"F:\Software_Engineering\Deepfake-Detection-new\data\archive", type=str, help='dataset path')
    parser.add_argument('--save_path', default='temp.npy', type=str, help='path to save the ERF matrix (.npy file)')
    parser.add_argument('--num_images', default=50, type=int, help='num of images to use')
    parser.add_argument('--model_path', default=r"F:\Software_Engineering\Deepfake-Detection-new\central_seed114514\19.pth", type=str, help='path of trained model')
...
if __name__ == '__main__':
    ...
    plt.savefig('erf_visualization.png', dpi=300, bbox_inches='tight')
    plt.show()
