...
# 定义基础命令
base_command="CUDA_VISIBLE_DEVICES=1 python train_fedDyn.py --num_clients 10 --num_rounds 20 --alpha 5.5 --lr_decay -1 --num_epoch 2 --log_dir logs1_fedDyn --batch_size 8 --dataset both"

# eval_command="CUDA_VISIBLE_DEVICES=1 python eval_central.py --batch_size 8 --threshold 8e-3 --log_dir logs1_fedDyn --dataset both --mode fed --savepcd"
eval_command="CUDA_VISIBLE_DEVICES=1 python eval_fed.py --batch_size 8 --threshold 8e-3 --log_dir logs1_fedDyn --dataset both  --savepcd"
...
# 定义日志文件的路径
log_file="script/fedDyn_active${active_rate}_multiple_seeds.log"
