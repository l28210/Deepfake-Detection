...
for seed in "${seeds[@]}"; do
    ...
    baseline_eval="CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} python eval_central.py --batch_size ${batch_size} --log_dir ${log_dir} --folder_data ${data_folder} --dataset ${data_set} --CPUs ${CPUs} --LARGE_KERNEL_CONV_IMPL ${LARGE_KERNEL_CONV_IMPL} --tag central_seed${seed}"
