...
# 定义基础命令
base_command="CUDA_VISIBLE_DEVICES=1 python train_fedavg.py --num_clients 10 --num_rounds 20 --alpha 5.5 --lr_decay -1 --num_epoch 2 --log_dir logs1_fedavg --batch_size 8 --dataset both"

eval_command="CUDA_VISIBLE_DEVICES=1 python eval_central.py --batch_size 8 --threshold 8e-3 --log_dir logs1_fedavg --dataset both --mode fed"
...
# 定义日志文件的路径
log_file="script/fedavg_active${active_rate}_multiple_seeds.log"
